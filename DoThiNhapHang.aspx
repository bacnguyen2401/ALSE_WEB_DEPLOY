<%@ Page Title="ĐỒ THỊ NHẬP HÀNG" Language="C#" MasterPageFile="~/Site.Master" EnableViewState="false" AutoEventWireup="true" CodeBehind="DoThiNhapHang.aspx.cs" Inherits="ALSE.DoThiNhapHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <dxchartsui:WebChartControl ID="WebChartControl1" runat="server" CrosshairEnabled="True" DataSourceID="SqlDataSource1"
        ...
        <seriesserializable>
                <cc1:Series ArgumentDataMember="NgayXeVe" ArgumentScaleType="DateTime" Name="Số Kiện" ValueDataMembersSerializable="SoKien">
                ...
                <cc1:Series ArgumentDataMember="NgayXeVe" ArgumentScaleType="DateTime" Name="Trọng Lượng" ValueDataMembersSerializable="TrongLuong">
                    <viewserializable>
        ...
        <titles>
                <cc1:ChartTitle Text="ĐỒ THỊ THỐNG KÊ HÀNG NHẬP" />
            </titles>
    </dxchartsui:WebChartControl>
    </div>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CARGOConnectionString %>" SelectCommand="WebDoThiHangNhap" SelectCommandType="StoredProcedure">
    ...
    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EnableTheming="True" Theme="Aqua">
        <Columns>
            ...
            <dx:GridViewDataDateColumn Caption="Ngày Nhập" FieldName="NgayXeVe" VisibleIndex="0">
