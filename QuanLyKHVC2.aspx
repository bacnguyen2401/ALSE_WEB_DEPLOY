<%@ Page Title="MANAGER SHIPPING SCHEDULE" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyKHVC2.aspx.cs" Inherits="ALSE.QuanLyKHVC2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="div-button" style="margin-bottom: 10px;">
        ...
        <a href="XemCanDIM.aspx"class="mani-btn btn btn-primary  btn-sm" target="_blank">Tra cứu DIM</a>
