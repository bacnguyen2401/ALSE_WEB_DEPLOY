<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyHangXuatKhachHang.aspx.cs" Inherits="ALSE.QuanLyHangXuatKhachHang" %>
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
     <%# Versioned.VersionedFiles.ScriptHelper.Render("css","css/custom/QuanLyHangXuatKhachHang.css") %>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <table class="header-table-export">
            ...
            <tr>
                <td colspan="2" class="text-center-button">
                    ...
                    <a href="XemCanDIM.aspx" class="mani-btn btn btn-danger btn-sm">Tra Cứu HX</a>
                    <%--<a href="QuanLyKhoHang.aspx" class="mani-btn btn btn-danger btn-sm">Storage</a>--%>
    ...
    <div id="temULI">
      ...
      <div id="temULITrang">
       ...
       <%# Versioned.VersionedFiles.ScriptHelper.Render("js","js/custom/QuanLyHangXuatKhachHang.js") %>
</asp:Content>
