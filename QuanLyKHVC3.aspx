<%@ Page Title="MANAGER SHIPPING SCHEDULE" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="QuanLyKHVC3.aspx.cs" Inherits="ALSE.QuanLyKHVC3" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div id="div-button" style="margin-bottom: 10px;">
       ...
       <%-- <a href="QueryListInVoices.aspx" runat="server" id="iInvoice" class="mani-btn btn btn-danger btn-sm">Query List by Invoice </a>--%>
        ...
        <%--<a href="InputExcel2.aspx" runat="server" id="iInputEcel" class="mani-btn btn btn-info  btn-sm">Nhập Kế Hoạch</a>--%>
...
<%--    <dx:ASPxGridView ID="ASPxGridView1" runat="server" AutoGenerateColumns="False"
    ...
    <asp:SqlDataSource ID="SqlDataSourceHangChuaTaoPhieuCan" runat="server" ConnectionString="<%$ ConnectionStrings:CARGOConnectionString %>" SelectCommand="WebHangChuaTaoPhieuCan_APX" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    <%--END BOOKING--%>
    <dx:ASPxGridView ID="ASPxGridView21" runat="server" KeyFieldName="SoMaWB" AutoGenerateColumns="False" CssClass="grid-view" DataSourceID="SqlDataSourceHangDaTaoPhieuCan" EnableTheming="True" Theme="Aqua" Width="1185px">
        ...
        <ClientSideEvents Init="function(s, e) {s.SetVisible(s.GetVisibleRowsOnPage() != 0);}" />
        <Columns>
            <dx:GridViewDataTextColumn FieldName="SoMaWB" VisibleIndex="2" Width="90px" Caption="MAWB">
                <CellStyle Font-Bold="True">
                </CellStyle>
            </dx:GridViewDataTextColumn>
    ...
    <dx:ASPxGridView ID="ASPxGridView31" runat="server" KeyFieldName="SoMaWB" AutoGenerateColumns="False" CssClass="grid-view" DataSourceID="SqlDataSourceHangDaDuyetPhieuCan" Theme="Aqua" Width="1185px">
        ...
        <ClientSideEvents Init="function(s, e) {s.SetVisible(s.GetVisibleRowsOnPage() != 0);}" />
        <Columns>
            <dx:GridViewDataTextColumn FieldName="SoMaWB" Caption="MAWB" VisibleIndex="2" Width="90px">
                <CellStyle Font-Bold="True">
                </CellStyle>
            </dx:GridViewDataTextColumn>
    ...
    <asp:SqlDataSource ID="SqlDataSourceHangDaGiaoXong" runat="server" ConnectionString="<%$ ConnectionStrings:CARGOConnectionString %>" SelectCommand="WebHangDaGiaoXongXuatEFL" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
    <%--END COMPLETE--%>

    
    
       <%# Versioned.VersionedFiles.ScriptHelper.Render("js","js/custom/quan-ly-khvc2.js") %>
    <script type="text/javascript">
        $(document).ready(function () {
            //$(".mo-wh").each(function () {
