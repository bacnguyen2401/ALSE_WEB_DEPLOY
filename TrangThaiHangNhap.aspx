<%@ Page Title="TRẠNG THÁI HÀNG NHẬP" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableViewState="false" CodeBehind="HangDaVeKho.aspx.cs" Inherits="ALSE.HangDaVeKho" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div>
        <div style="float: right; width: 800px">
            <p style="font-size: 30px; text-align: left; color: white;">IMPORT CARGO STATUS</p>
        </div>
        <div style="float: left">
            <dx:ASPxButton ID="ASPxButtonRF" runat="server" Text="Refresh" OnClick="ASPxButtonRF_Click"></dx:ASPxButton>
            <div id='countdown' style="color: white;"></div>
            <dx:ASPxTimer ID="ASPxTimerAR" runat="server" Interval="300000" OnTick="ASPxTimerAR_Tick"></dx:ASPxTimer>
        </div>
    </div>
    <!--END HEADER-->
    <!--BUTTON-->
    <div style="width: 100%; margin-top: 60px; margin-bottom: 10px;" class="div-trangthaihangnhap-button">
    ...
    <div style="margin-bottom: 10px">
        ...
        <table class="tablehx" style="border-style: solid; border-color: inherit; border-width: 1px; width: 1226px; height: 100px; background-color: white; padding: 3px;">
            <tr>
                <td class="auto-style20" colspan="2">Total Arrival Notice:</td>
                <td class="auto-style20" colspan="2">Plan Tomorrow:</td>
                <td class="auto-style20" colspan="2">Plan Today:</td>
                <td class="auto-style20" colspan="2">ALSE WH:</td>
                <td class="auto-style20" colspan="2">Clear CD:</td>
                <td class="auto-style20" colspan="2">Delivering:</td>
                <td class="text-center" colspan="2">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/DoThiNhapHang.aspx">In ALSE Y'Day</asp:HyperLink>
                </td>
                <td class="auto-style20" colspan="2">In ALSE Today</td>
            ...
            <tr>
                <td class="auto-style31">
                    <dx:ASPxLabel ID="ASPxLabelANShipment" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style33">Shpt</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelAN1Shipment" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style25">Shpt</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx1" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style5">Shpt</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx4" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style27">Shpt</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx7" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx10" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>

                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx16" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>
                <td>
                    <dx:ASPxLabel ID="ASPxLabelx19" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>
                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx22" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>
                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx13" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td>Shpt</td>
            </tr>
            <tr>
                <td class="auto-style31">
                    <dx:ASPxLabel ID="ASPxLabelANPcs" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style34">Pcs</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelAN1Pcs" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style25">Pcs</td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx2" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style4"><span>Pcs</span></td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx5" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style27"><span>Pcs</span></td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx8" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
                <td class="auto-style2">
                    <dx:ASPxLabel ID="ASPxLabelx11" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
                <!--FWD-->
                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx17" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
                <td>
                    <dx:ASPxLabel ID="ASPxLabelx20" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx23" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
                <td class="text-right">
                    <dx:ASPxLabel ID="ASPxLabelx14" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td><span>Pcs</span></td>
            </tr>
            <tr>
                <td class="auto-style32">
                    <dx:ASPxLabel ID="ASPxLabelANKgs" runat="server" Font-Bold="true">
                    </dx:ASPxLabel>
                </td>
                <td class="auto-style34">Kgs</td>
                <td class="auto-style21">
                    <dx:ASPxLabel ID="ASPxLabelAN1Kgs" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style26">Kgs</td>
                <td class="auto-style21">
                    <dx:ASPxLabel ID="ASPxLabelx3" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style4"><span>Kgs</span></td>
                <td class="auto-style21">
                    <dx:ASPxLabel ID="ASPxLabelx6" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style28"><span>Kgs</span></td>
                <td class="auto-style21">
                    <dx:ASPxLabel ID="ASPxLabelx9" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
                <td class="auto-style21">
                    <dx:ASPxLabel ID="ASPxLabelx12" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
                <td class="auto-style35">
                    <dx:ASPxLabel ID="ASPxLabelx18" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
                <td class="auto-style22">
                    <dx:ASPxLabel ID="ASPxLabelx21" runat="server" Text="" Font-Bold="True" Style="text-align: right"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
                <td class="auto-style35">
                    <dx:ASPxLabel ID="ASPxLabelx24" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
                <td class="auto-style35">
                    <dx:ASPxLabel ID="ASPxLabelx15" runat="server" Text="" Font-Bold="True"></dx:ASPxLabel>
                </td>
                <td class="auto-style22"><span>Kgs</span></td>
            </tr>
        </table>
    ...
    <dx:ASPxGridView ID="ASPxGridView6" runat="server" AutoGenerateColumns="False" CssClass="grid-view arrivalnotice tomaudelay" DataSourceID="SqlDataSourceHangDaCoMatTaiSanBay" Theme="Aqua">
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="HAWB" VisibleIndex="2" Width="120px" CellStyle-CssClass="hawbcl">
    ...
    <dx:ASPxGridView ID="ASPxGridView5" runat="server" AutoGenerateColumns="False" CssClass="grid-view tomaudelay tomaufltdt delyveryplan" DataSourceID="SqlDataSourceWebKeHoachLayHang" Theme="Aqua">
        ...
        <Columns>
            ...
            <dx:GridViewDataTextColumn FieldName="HAWB" VisibleIndex="2" Width="120px">
                <CellStyle Font-Bold="True">
                </CellStyle>
            </dx:GridViewDataTextColumn>
            <dx:GridViewDataTextColumn FieldName="SoKienTB" VisibleIndex="3" Width="45px" Caption="PCS">
            ...
            <dx:GridViewDataTextColumn FieldName="GhiChuTB" VisibleIndex="16" Width="57px" CellStyle-CssClass="remark" Caption="REMARK">
            </dx:GridViewDataTextColumn>
            ...
            <dx:GridViewDataImageColumn VisibleIndex="0" Width="105px" Caption="STATUS">
                <PropertiesImage>
                    <EmptyImage Height="32px" Url="~/images/DELIVERY PLAN.png" Width="80px">
                    </EmptyImage>
                </PropertiesImage>
            </dx:GridViewDataImageColumn>
            <dx:GridViewDataTextColumn Caption="PCS TRUE" Width="45px" VisibleIndex="13" FieldName="SoKienThuc">
    ...
    <!--END COMPLETE-->
    <!-------------------------------->
    <%# Versioned.VersionedFiles.ScriptHelper.Render("js","js/custom/trang-thai-hang-nhap.js") %>
